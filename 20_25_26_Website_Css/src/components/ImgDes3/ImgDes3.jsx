...
import I100 from '../../assets/100.jpg';
import I96 from '../../assets/96.jpg';


function ImgDes3() {
  return (
    <>
            <section className="py-5 position-relative b322">
		<div className="position-absolute col-lg-6 col-12 col-sm-12 " style={{top:"0%", left:"-5%", zIndex:"-1"}} >
		     <img src={I100} width="75%"  alt="100"/>
		    </div>
		  <div className="container">
		    <div className="row ">
			   <div className="col-lg-6 col-12 col-sm-12  pe-5 our-3"><img src={I96	} alt="96" className="img-fluid"/></div>
