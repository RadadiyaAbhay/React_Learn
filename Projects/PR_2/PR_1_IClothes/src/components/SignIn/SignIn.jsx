...
export default function SignIn() {
  let { isLogin, isLoading, err } = useSelector(state => state.userReducer);
        ...
        <section className="bg-white dark:bg-gray-900">
          <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
            <form className="w-full max-w-md" onSubmit={handleSubmit}>
              ...
              <h1 className="mt-0 text-2xl font-semibold text-gray-800 capitalize sm:text-3xl dark:text-white">sign In</h1>
              ...
              <div className="mt-6">
                ...
                <p onClick={handleGoogleSignIn} className="flex point items-center justify-center px-6 py-3 mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <div className="mt-6 text-center ">
                  <NavLink to={'/signup'} className="text-sm text-blue-500 hover:underline dark:text-blue-400">
