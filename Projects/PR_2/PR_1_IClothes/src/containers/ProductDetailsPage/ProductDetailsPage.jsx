...
export default function ProductDetailsPage() {
  const { singleProduct ,isLoading , err } = useSelector(state => state.productReducer)
  const { cartProduct } = useSelector(state => state.cartReducer)
  const { isLogin, user } = useSelector(state => state.userReducer)
  const reviews = { href: '#', average: singleProduct.rating, totalCount: 117 }
  const product = {
    ...
    colors: [
      ...
      { name: 'red', class: 'bg-rose-900', selectedClass: 'ring-rose-900' },
    ],
    sizes: [
      ...
      return (
        <div className="bg-white">
          <div className="pt-6">
            ...
            {/* Product info */}
            <div className="mx-auto max-w-2xl px-4 pb-8 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-0 lg:pt-16">
